...
class PlaceholderController extends Controller
{
    public function svg(Request $request)
    {
        ...
        $svg = '<?xml version="1.0" encoding="UTF-8"?>'
            ...
            . '<stop offset="0%" stop-color="#416423"/>'
            . '<stop offset="100%" stop-color="#2A421A"/>'
            . '</linearGradient></defs>'
            . '<rect width="600" height="400" fill="url(#g)"/>'
            . '<circle cx="500" cy="80" r="140" fill="#A5E17D" fill-opacity="0.22"/>'
            . '<circle cx="90" cy="340" r="110" fill="#A5E17D" fill-opacity="0.15"/>'
